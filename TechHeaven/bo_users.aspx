                                ...
                                <ItemTemplate>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td scope="row"><%# Convert.ToBoolean(Eval("status")) ? "Yes" : "No" %></td>                                       
                                            <td scope="row"><%# Eval("role")%></td>
                                            <td scope="row"><%# Eval("NIF")%></td>
                                            <td scope="row"><%# Eval("tfa")%></td>
                                            <td scope="row"><%# Eval("newsletter")%></td>
                                            <td scope="row">
                                                <asp:LinkButton ID="edit_user" runat="server" OnCommand="edit_user_Command" CommandName="Edit" CommandArgument='<%# Eval("userId") %>'>
